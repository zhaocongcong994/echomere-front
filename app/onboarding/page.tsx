    ...
    <div className="min-h-screen bg-stone-50 flex flex-col">
      <header className="bg-white border-b border-stone-100">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-2">
          ...
          <span className="font-semibold">MetaSight</span>
        </div>
      </header>
        ...
        <div className="w-full max-w-xl bg-white rounded-2xl border border-stone-100 p-8 shadow-sm">
          ...
          {step === 1 && (
            <div className="text-center space-y-4">
              <h1 className="text-2xl font-medium">欢迎来到 MetaSight</h1>
              <p className="text-stone-500">
                元见会引导你建立命盘档案，开启 AI 命理分析之旅。
              </p>
          ...
          {step === 5 && (
            <div className="text-center space-y-4">
              ...
              <Button onClick={submit} disabled={loading}>
                {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : "进入 MetaSight"}
              </Button>
            </div>
          )}
        </div>
